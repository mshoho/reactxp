...
AutoFocusHelper_1.initAutoFocus('windows', function () { return UserInterface_1.default.isNavigatingWithKeyboard(); });
...
(function (ReactXP) {
    ...
    var windowsAnimatedClasses = __assign({}, Animated_1.CommonAnimatedClasses, { View: RN.Animated.createAnimatedComponent(View_1.default) });
