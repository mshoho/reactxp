...
AutoFocusHelper_1.initAutoFocus('macos', function () { return UserInterface_1.default.isNavigatingWithKeyboard(); });
...
(function (ReactXP) {
    ...
    var macAnimatedClasses = __assign({}, Animated_1.CommonAnimatedClasses, { TextInput: RN.Animated.createAnimatedComponent(TextInput_1.default) });
